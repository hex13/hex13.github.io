    ...
    energy: 100, maxEnergy:100,  x:400, y:100, handlers: {
            ...
            destroy: function(msg) {
                for (var i=0; i<5; i++) {
                    ...
                    var vy = -(Math.random() - 0.5)*4 - 1;                    
                    engine.createSprite( {type:'apple', img: images.apple, vrotation:56, 
                                          x: this.properties.x, y:this.properties.y, 
                                          vx:vx, vy:vy, gravity:0.3, maxLifeTime:4000});
     ...
     actions: {
       'start': [            
            ...
            create(engine, {type:'apple', img: images.apple, vrotation:56, 
                            x:90, y:40, vx:-0.4, vy:-1.5, 
                            gravity:0.3, maxLifeTime:4000}, true, false),            
            create(engine, {type:'apple', img: images.apple, vrotation:56, 
                            x:90, y:40, vx:0.3, vy:-1.5, 
                            gravity:0.3, maxLifeTime:4000}, true, false),            
...
function level1() {
    ...
    var witch = engine.createSprite([Witch, {x:Math.random()*300}]);      
